...
#define STRING_CONFIG_H_AUTHOR "Big Daddy" // Who made the changes.
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  230, 0, (Z_MIN_POS + 8) } }
  #define NOZZLE_CLEAN_END_POINT   { { 245, 40, (Z_MIN_POS + 8) } }
